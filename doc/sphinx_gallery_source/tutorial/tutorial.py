...
This page is a detailed tutorial of |igraph|'s Python capabilities. To get an quick impression of what |igraph| can do, check out the :doc:`../examples/quickstart`. If you have not installed |igraph| yet, follow the :doc:`../install`.

.. note::
   For the impatient reader, see the :doc:`../examples/index` page for short, self-contained examples.
"""
...
#
# If you are in a jupyter notebook, you do not need to start Python as the notebook kernel takes care of that for you.

# %%
# Importing igraph is straightforward:
...
# 
# It is also possible to call the script :command:`igraph` from your terminal::
#
#  $ igraph
