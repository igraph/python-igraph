...
.. figure:: ./figures/betweenness.png
   ...
   Graph visualizing edge betweenness (a) in a Krackhardt Kite graph and (b) in a 150 node Watts-Strogatz graph. The edge betweenness is shown in blue, and the vertex betweenness is shown in purple.
